...
<div id="wrapper">
  ...
  <div id="o">
    <div id="jjj"><strong>Search for  PhotoCash to buy.</strong> | <a class="blue" href="http://www.photocash.org/browse.php?id=<?PHP $id = $_GET["id"];  echo $id; ?>">Browse photos.</a></div>
  </div>
  <form id="submit" action="search_info.php?id=<?PHP $id = $_GET["id"];  echo $id; ?>" method="post">
  <div id="companyinfod">
    <div id="descriptionv">
      <p>
        <label>
          <input type="text" placeholder="<?PHP $query = "SELECT * FROM company WHERE RAND()";
...
?>" name="search" id="search" />
  ...
  <div id="buttonsclickon">
    <div id="but1"><input type="image" name="search" src="http://www.photocash.org/img/search.png" alt="" width="293" height="59" /></div>
  </div></form>
